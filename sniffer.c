...
int hook_netif_receive_skb(struct sk_buff *skb)
{
    ...
    return trampoline_netif_receive_skb(skb);
}
...
static int kubisti_sniffer_init(void)
{
    ...
    original_netif_receive_skb = (void*) kallsyms_lookup_name("netif_receive_skb");
    ...
    *trampoline_pointer = (unsigned long) original_netif_receive_skb + ASSEMBLY_LENGTH;
    ...
    /* set pointer to trampoline */
    trampoline_netif_receive_skb = (void*) old_proluge;
